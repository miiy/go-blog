...
func (r *Repository) Get(ctx context.Context, id, userId int64) (*UserTag, error) {
...
func (r *Repository) ListCount(ctx context.Context, userId int64) (int64, error) {
	// count
...
func (r *Repository) List(ctx context.Context, userId, limit, offset int64) ([]*UserTag, error) {
	// query
