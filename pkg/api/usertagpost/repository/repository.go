...
func (r *Repository) PostListCount(ctx context.Context, userId, tagId int64) (int64, error) {
	// count
...
func (r *Repository) PostList(ctx context.Context, userId, tagId, limit, offset int64) ([]*UserTagPost, error) {
	// query
